...
print('* Escolha um intervalo numerico *')
limite_inferior = int(input('Entre com um numero para o limite inferior do intervalo: '))
limite_superior = int(input('Entre com um numero para o limite superior do intervalo: '))
print(f'Pense num numero no intervalo entre {limite_inferior} e {limite_superior}.')
    ...
    while not resposta:
        ...
        if acertou == 's':
            ...
            if maior_ou_menor == 'me':
                ...
                numero = rd.randint(limite_inferior, limite_superior)
            print('-' * 40)
            print(f'O numero pensado esta entre {limite_inferior} e {limite_superior} !')
            print('-' * 40)
